			...
			<div class="card">
				...
				<div class="card-body">
					...
					<tbody>
						...
						$no = 1;
						$query = mysqli_query($koneksi, "SELECT a.*,b.* FROM tb_pengaduan a INNER JOIN tb_masyarakat b ON a.nik=b.nik ORDER BY id_pengaduan DESC");
						while ($data = mysqli_fetch_array($query)) { ?>
							...
							<tr>
								...
								<td><img src="../dist/img/<?php echo $data['foto'] ?>" width="100"></td>
								<td>
									<?php
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h1 class="modal-title fs-5" id="exampleModalLabel">Verifikasi : <?php $data['judul_laporan'] ?></h1>
												...
												if (isset($_POST['kirim'])) {
													...
													$query = mysqli_query($koneksi, "UPDATE tb_pengaduan SET status='$status' WHERE id_pengaduan='$id_pengaduan'");
													echo " <script>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="" method="POST">
														...
														<div class="row mb-3">
															...
															<div class="col-md-8">
																<img src="../dist/img/<?php echo $data['foto'] ?>" width="100">
															</div>
														</div>
														<div class="row mb-3">
												...
												if (isset($_POST['kirim_tanggapan'])) {
													...
													$query_tanggapan = mysqli_query($koneksi, "INSERT INTO tb_tanggapan VALUES ('','$id_pengaduan', '$tanggal', '$tanggapan', '$id_petugas')");
													if ($tanggapan != NULL) {
														$UPDATE = mysqli_query($koneksi, "UPDATE tb_pengaduan SET status='selesai' WHERE id_pengaduan='$id_pengaduan' ");
													}
													echo " <script>
