    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="card-footer">
          ...
          <a href="index.php?page=login" class="n-3">sudah punya akun? Login disini</a>
        </div>
      </form>
    </div>
  </div>
...
if (isset($_POST['kirim'])) {
  ...
  $query = mysqli_query($koneksi, "INSERT INTO tb_masyarakat VALUES ('$nik', '$nama', '$username', '$password', '$telp', '$level')");
